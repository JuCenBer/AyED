...
public class Test {
	public static void main(String[] args) {
		...
		ListaGenerica<Integer> nuevaLista = new ListaEnlazadaGenerica<Integer>();
		nuevaLista = RecorridosAG.numerosImparesMayoresQuePreOrden(a, 5);
		
		nuevaLista.comenzar();
		while(! nuevaLista.fin()) {
			System.out.println(nuevaLista.proximo());
		}
		
		System.out.println("--------------------------------");
		nuevaLista = new ListaEnlazadaGenerica<Integer>();
		nuevaLista = RecorridosAG.numerosImparesMayoresQueInOrden(a, 5);
		...
		System.out.println("--------------------------------");
		nuevaLista = new ListaEnlazadaGenerica<Integer>();
		nuevaLista = RecorridosAG.numerosImparesMayoresQuePostOrden(a, 5);
		...
		System.out.println("--------------------------------");
		nuevaLista = new ListaEnlazadaGenerica<Integer>();
		nuevaLista = RecorridosAG.numerosImparesMayoresQuePorNiveles(a, 5);
